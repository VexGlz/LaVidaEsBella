 ...
 * @author angel
 */
public class DarBajaMascota extends javax.swing.JDialog {

    /**
     * Creates new form ConfirmacionEliminarDialog
     */
    public DarBajaMascota(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Dar de Baja Mascota");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DarBajaMascota.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DarBajaMascota dialog = new DarBajaMascota(new javax.swing.JFrame(), true);
