...
//
//                return ResultadoOperacion.exito("Mascota dada de baja correctamente");
//            } else {
//                return ResultadoOperacion.error("No se encontró la mascota en la base de datos");
//            }
//        } catch (Exception e) {
//            System.err.println("Error al dar de baja: " + e.getMessage());
//            return ResultadoOperacion.error("Error inesperado al dar de baja: " + e.getMessage());
//        }
//    }
//}
