 ...
 * @author angel
 */
public class EditarMascotaDialog extends javax.swing.JDialog {

    /**
     * Creates new form AgregarMascotaDialog
     */
    public EditarMascotaDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarMascotaDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditarMascotaDialog dialog = new EditarMascotaDialog(new javax.swing.JFrame(), true);
